  ...
  return (
    <div className="flex h-full w-full items-center justify-center bg-black py-10">
      <div className="mx-auto flex h-full w-full max-w-screen-xl flex-col px-10">
        <div className="mb-4">
          <p className="mb-2 text-4xl font-bold">TWAN LUTTIK</p>
          <p className="mb-10 font-bold">I{`'`}m a simple software engineer</p>
        ...
        <div className="flex items-center">
          ...
          <p className="mb-1 text-xl text-white">
            Check out the <strong>twan de burger</strong> song
          </p>
        </div>

        <p className="cursor-pointer select-none transition-all hover:opacity-70 active:opacity-60">
          https://github.com/Brendonovich/twan-de-burger
        </p>
        ...
        <div className="mt-2 flex flex-col gap-y-0.5">
          <div className="group mb-4">
            <p className="cursor-pointer text-green-400 transition-all group-hover:underline ">
              coatcheck.app
            </p>
          ...
          <div className="group mb-4">
            <div className="flex flex-row gap-x-2">
              <p className="cursor-pointer text-green-400 group-hover:underline">
                streambk.com
              </p>
...
const LinkComp = ({
  ...
  return (
    <div className="group flex w-fit cursor-pointer flex-row">
