...
const projects: Project[] = [
  {
    id: "1",
    title: "coatcheck.app",
    description: "A web application for managing coat checks and event logistics",
  ...
  },
  {
    id: "2",
    title: "limemap.app",
    description: "Interactive map application for location-based services",
  ...
  },
  {
    id: "3",
    title: "dotenvx-gui",
    description: "GUI application for managing environment variables with dotenvx",
  ...
  },
  {
    ...
    description: "Chat interface GUI for Ollama AI models",
